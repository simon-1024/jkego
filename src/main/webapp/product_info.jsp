...
<head>
    ...
    <script type="text/javascript">
        ...
        function addCart(){
            ...
            location.href="${pageContext.request.contextPath}/product/addProductToCart?pid=${productInfo.pid}&buyNum="+buyNum;
        }
    </script>
</head>
...
<div class="container">
    <div class="row">
        ...
        <div style="margin: 0 auto; width: 950px;">
            ...
            <a href="${pageContext.request.contextPath}/product/productList?cid=${cid}&currentPage=${currentPage}">
                返回列表页面</a>
        </div>
        <div class="clear"></div>
